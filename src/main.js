...
// Event click and form.preventDefault -----------------------------------------
...
// Event input and get value name ----------------------------------------------
...
function updateCardNumber(code) {
  ...
  ccNumber.innerText = code.length ? code : "1234 5678 9012 3456"
}
...
function updateExpirationDate(code) {
  ...
  ccExpiration.innerText = code.length ? code : "02/32"
}
